...
function do_header($title, $id='home') {
	...
	echo '<style type="text/css" media="screen">@import "'.$globals['base_url'].'css/es/mnm15-5.css";</style>' . "\n";
	...
	echo '<script src="'.$globals['base_url'].'js/xmlhttp08.js" type="text/javascript"></script>' . "\n";
	echo '<script src="'.$globals['base_url'].'js/tooltip01.js" type="text/javascript"></script>' . "\n";
	echo '</head>' . "\n";
