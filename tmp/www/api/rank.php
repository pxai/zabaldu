...
$sql = "SELECT link_id, link_url, link_votes, link_negatives, link_karma from links WHERE link_date > DATE_SUB(now(), INTERVAL $days DAY) AND link_status != 'discard' ORDER BY link_votes DESC, link_karma DESC LIMIT $rows";
$link = new Link;
