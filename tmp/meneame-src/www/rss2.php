...
if ($links) {
	foreach($links as $link_id) {
		...
		echo '<p>'.$content.'</p>';
		echo '<p><img src="http://'. get_server_name() .$globals['base_url'].'backend/votes_img.php?id='. $link->id .'" alt="votes" />';
		echo '&nbsp;<img src="http://'. get_server_name() .$globals['base_url'].'backend/comments_img.php?id='. $link->id .'" alt="comments" /></p>';
