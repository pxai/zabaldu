...
function to_html(data) {
	...
	/* All the others */
	if (data.type == 'vote')
		html += '<div class="sneakertype"><img src="http://<? echo get_server_name().$globals['base_url'];?>netvibes/icons/sneak-voteS.png" width="15" height="12" alt="voto" title="voto" /></div>';
